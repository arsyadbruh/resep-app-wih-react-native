        ...
        <Box bg={"white"} p={5} m={5}>
          <Center>
            ...
            <Text fontSize={"lg"} mt={3} textAlign={"justify"}>
              Ini adalah aplikasi untuk menemukan resep resep kelas dunia yang sangat enak dan mudah
              dibuat untuk rumahan
            </Text>
            <Text fontSize={"lg"} mt={3} textAlign={"justify"}>
              Selain Resep juga ada berbagai tips trick memasak, inspirasi untuk dapur dan masih
              banyak lagi. Terima kasih kepada tomorisakura untuk Food recipes api bahasa Indonesia
              🇮🇩 build with Cheerio and Node js
            </Text>
